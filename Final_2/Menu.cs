namespace itm.csharp.basic
{
    public static class Menu
    {
        ...
        {
            Console.WriteLine("1. Encuentra el Mes de acuerdo al numero dado.");
            Console.WriteLine("2. Ordena 3 numeros en orden ascendente.");
            ...
            Console.WriteLine("Ingrese el número del ejercicio que desea ejecutar, o 'q' o 'exit' para salir:");
        }
    }
}